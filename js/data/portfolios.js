const portfolios = [
  {
    ...
    description: `<p>
    Halaman Personal is a website builder (web) application which allows its users
    to provide information about them. The website that generated by
    HalamanPersonal is simillar to online CV, but with style and more interactive,
    and also simillar to portfolio/personal website.
  </p>
  <p>This app is consist of three services.</p>
  <br />
  <ul style="list-style-type: none">
    <li>
      First, <a target="_blank" href="https://halamanpersonal.my.id">halamanpersonal.my.id</a> is
      for client-side (end-user do almost everything here).
    </li>
    <li>
      Second,
      <a target="_blank" href="https://halamanpersonal-backend.herokuapp.com"
        >halamanpersonal-backend.herokuapp.com</a
      >
      is for backend services and serving API.
    </li>
    <li>
      Third,
      <a target="_blank" href="https://halamanpersonal-images.my.id"
        >halamanpersonal-images.my.id</a
      >
      is for image hosting.
    </li>
  </ul>
  <br />
  <p>
    ...
    <a target="_blank" href="https://halamanpersonal-images.my.id"
      >halamanpersonal-images.my.id</a
    >
    was built because every time our backend push a new update to production
    branch, all files that has been uploaded to the server (Heroku) were gone. So
    we decided to create another app that only meant for uploading images (the app
    hosted on a cheap shared-hosting).
  </p>`,
    technology: 'React • Next.js • Laravel • PostgreSQL • Sass',
    image:
